    ...
    <>
      <div>
        ...
        {openSidebar && (
          <div
            id="docs-sidebar"
            className="w-full fixed top-0 left-0 bottom-0   max-w-[250px] bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y md:block lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700"
          >
            <div className="px-6">
              <Link
                passHref
              ...
              >
                ...
                <div className="flex">
                  <img
                    ...
                    loading="lazy"
                  />
                  <span className="pt-5  ml-5 text-[16px]">Parash Giri</span>
                </div>
              </Link>
            </div>
            <nav
                ...
                <li className="hs-accordion" id="users-accordion">
                  ...
                  <div
                    ...
                    className={`hs-accordion-content w-full overflow-hidden transition-[height] duration-300 ${
                      activeDropdown === "users-accordion" ? "block" : "hidden"
                    }`}
                  >
                    <ul
